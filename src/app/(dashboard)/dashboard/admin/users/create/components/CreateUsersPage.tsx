...
export default function CreateUsersPage() {
    ...
    const handleFileUpload = (data: UserData[], file: File) => {
        ...
        handleFileDataReceived(data, file, enrichmentData);
    };
    ...
    return (
        <div className="w-full max-w-5xl flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6 space-y-7">
