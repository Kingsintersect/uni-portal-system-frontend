...
export const DeleteCourseAssignment = ({ access_token, id }: { access_token: string, id: string }) => {
   const router = useRouter();

   const handleCourseDelete = async (id: string) => {
      const { error, success } = await DeleteSingleCourseAssignment(access_token, id);
      if (error) {
